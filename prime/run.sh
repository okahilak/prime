...
python3 train.py --train 18 19 20 23 25 28 29 35 40 42 43 44 45 50 101 102 107 108 110 111 113 115 116 120 125

# Test datasets from the first fold of the cross-validation split
python3 train.py --test 21 22 24 26 27 31 34 36 38

# Loop over test datasets
for subject_id in 21 22 24 26 27 31 34 36 38; do
    python3 simulate_online.py "$subject_id"
    exit_code=$?
